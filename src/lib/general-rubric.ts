...
- priority_explanation and every next_steps[].observation (weak/mid bands only; strong bands stay praise-only per the Strong next_steps rule above) follow the SAME two-part structure, always, 3-4 short sentences TOTAL, never an essay:
  ...
  - Lighting/glare: "Harsh direct light makes a bright spot that hides the surface texture." + "Move the piece next to a window in soft daylight, or bounce a lamp through a white sheet of paper about a foot away."
  ...
  - Digital preview/text: "The page preview is too small to read, so buyers cannot tell what the pages look like." + "Crop the mockup so a single page fills at least 60% of the frame, or increase the preview image resolution before uploading."
  ...
  RIGHT next_step (problem + action, matches the rule): { "observation": "The lighting is flat and hides the surface texture. Position a desk lamp about a foot away at a slight angle, diffused through a white sheet of paper, so one side catches a soft shadow.", "action": "Angle a diffused lamp for texture." }
