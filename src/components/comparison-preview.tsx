...
export function ComparisonPreview({
  ...
  return (
    <div className="flex gap-1 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-white p-1 shadow-[0_1px_2px_rgba(25,23,20,0.04)]">
      <TabButton
...
function TabButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex-1 rounded-[var(--radius-md)] px-4 py-2 text-[13px] font-semibold transition-all",
        active
